...
Source0  : https://github.com/acpica/acpica/files/14718332/acpica-unix2-20240321.tar.gz
...
%prep
%setup -q -n acpica-unix2-20240321
cd %{_builddir}/acpica-unix2-20240321
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722287808
