...
Version  : 20210730
Release  : 59
URL      : https://acpica.org/sites/acpica/files/acpica-unix2-20210730.tar.gz
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20210730.tar.gz
...
%prep
%setup -q -n acpica-unix2-20210730
cd %{_builddir}/acpica-unix2-20210730
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627666487
