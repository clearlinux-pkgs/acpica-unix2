...
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20220331.tar.gz
...
%prep
%setup -q -n acpica-unix2-20220331
cd %{_builddir}/acpica-unix2-20220331
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648765218
